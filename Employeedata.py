...
while True:
    ...
    if Choice == 1:
        ...
        result = connection.execute("update Employee set employee_name='"+getemployee_name+"',phone="+getphone+",email='"+getemail+"',employee_designation='"+getdesignation+"',salary="+getsalary+",company_name='"+getcompany_name+"' where employee_code="+getemployee_code+"")
        connection.commit()
